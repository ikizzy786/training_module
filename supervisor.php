...
<body>
    ...
    <!-- SUPERVISOR VERIFY POP UP FORM (Bootstrap MODAL) -->
                ...
                <form action="verify.php" method="POST" id="supervisor_form">
                    ...
                    <div class="modal-body">
						...
						<label for="myfile"><b>Training Documents:</b></label>
						 ...
						 <div class="form-group">
							<label for="supervisor_approval"><B>Supervisor Approval:</B></label>
							<input type="checkbox" id="supervisor_approval" name="supervisor_approval" required>
						</div>
						<div class="form-group">
							<label for="supervisor_comment"><B>Supervisor Comment:</B></label>
							<textarea class="form-control" id="supervisor_comment" name="supervisor_comment"></textarea>
						</div>
